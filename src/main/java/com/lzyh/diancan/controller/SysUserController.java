...
import com.lzyh.diancan.service.impl.SysUserServiceImpl;
...
public class SysUserController {
    ...
    @Autowired
    public SysUserController(UserUtil userUtil, SysUserServiceImpl userService) {
...
//        User userDto = new User();
     ...
     */
    @GetMapping("/{id}")
    @RequiresPermissions(logical = Logical.AND, value = {"sys:user:list"})
    ...
    @PostMapping("/add")
    @RequiresPermissions(logical = Logical.AND, value = {"sys:user:list"})
    public ResponseBean add(SysUser user) {
        // 判断当前帐号是否存在
